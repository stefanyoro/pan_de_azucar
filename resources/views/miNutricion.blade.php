    				...
    				<div class="card" style="border-color:#B03A2E;">
						<div class="card-body">
					    	<div class="">
					    		<div class="row">
					    			<div class="col-md-12">
					    				<p style="text-align: center;"><b>PDF Plan Alimenticio</b></p><br>
			  					
			  					<div class="text-justify">
			  						Este plan de alimentación esta creado como base en buena alimentacion para todos los corredores de la página. Duración: 1 semana.
			  					</div><br>
					                            			...
					                            			@if($plan->status == 1)
							                              	<tr>
									                            ...
									                            <div class="btn-group" role="group" aria-label="Basic example">
									                              <button type="button" class="btn btn-outline-info btn-sm"><a href="{{ url('nutricionPDF/'.$plan->id) }}" target="_black" value="{{$plan->id}}" style="color: black;">
