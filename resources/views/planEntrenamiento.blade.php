		  		...
		  		<div class="card-body">
		    		<div class="">
				            <form action="RegistrarCorredor" method="post">@csrf
				                ...
				                <div class="row" style="margin-top: 15px;">
				                    <div class="col-md-12"> 
				                      <input type="email" class="form-control" id="correo" name="correo" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" data-pattern-error="La dirección de correo es inválida" placeholder="Correo" required="required">
				               		...
				               		<div class="card-header" style="height:50px; background-color:#F2F3F4;"> 
				                ...
				                <div class="row">
				                    <div class="col-md-6"> 
				                          <input type="password" name="contraseña0" class="form-control" id="contraseña0" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}" minlength="8" maxlength="16" title="Debe contener al menos un número, una letra mayúscula, una letra minúscula y ser de 8 a 16 caracteres" required="required" data-pattern-error="Debe contener al menos un número, una letra mayúscula, una letra minúscula y ser de 8 a 16 caracteres" placeholder="Contraseña">
				                    </div>  
				                    <div class="col-md-6">
				                         <input type="password" name="contraseña1" class="form-control" id="contraseña1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}" minlength="8" maxlength="16" title="Debe contener al menos un número, una letra mayúscula, una letra minúscula y ser de 8 a 16 caracteres" required="required" data-pattern-error="Debe contener al menos un número, una letra mayúscula, una letra minúscula y ser de 8 a 16 caracteres" placeholder="Confirmar contraseña">
				                    </div>
				                </div><br>
				           	<div class="row">
				                	...
				                	<div class="col-md-6">
			                      		...
			                      		<div class="col-md-6">
			                          		<input type="submit" class="btn btn-primary btn-block py-3" value="Guardar" style=" border:none; outline: none; border-radius: 20px; height: 50px; width: 150px;">
			                      		</div>
